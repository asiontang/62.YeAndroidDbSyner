    ...
    class SystemErrorCodes
    {
        ...
        public static string ToString(Int32 ERR)
        {
            switch (ERR)
            {
                ...
                case 0: return "操作无法正确的完成。The operation completed successfully.";
                case 1: return "不正确的方法。Incorrect function.";
                case 10: return "环境是不正确的。The environment is incorrect.";
                ...
                case 111: return "文件名太长。The file name is too long.";
                ...
                case 16: return "目录无法移除。The directory cannot be removed.";
                case 160: return "一个或多个参数不正确。One or more arguments are not correct.";
                case 161: return "指定的路径无效。The specified path is invalid.";
                ...
                case 2: return "系统无法找到指定的文件。The system cannot find the file specified.";
                case 20: return "系统无法找到知道的设备。The system cannot find the device specified.";
